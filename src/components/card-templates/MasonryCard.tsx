    ...
    >
      <main className="mx-auto w-full max-w-md px-5 pb-24 pt-12">
        <header className="card-rise flex items-center gap-3.5">
          <div
            className="card-avatar flex h-28 w-28 shrink-0 items-center justify-center overflow-hidden rounded-full"
        ...
        <SaveContact
          card={card}
          className="mt-6 flex h-12 items-center justify-center rounded-xl text-[13px] font-bold"
